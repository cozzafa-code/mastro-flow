  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
        ...
        {/* Avatar + Impostazioni — bottone unico */}
        <button onClick={() => router.push('/impostazioni')} style={{
          ...
          {/* T in alto-sx, ingranaggio in basso-dx */}
          <span style={{ position: 'absolute', top: 8, left: 11, fontFamily: "'Fredoka', sans-serif", fontSize: 14, fontWeight: 700, color: '#fff', textShadow: '0 1px 2px rgba(0,0,0,0.2)', zIndex: 2, lineHeight: 1 }}>T</span>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.75)" strokeWidth="2" strokeLinecap="round" style={{ position: 'absolute', bottom: 7, right: 7, zIndex: 2 }}>
