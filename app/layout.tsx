  ...
  return (
    <html lang="it" suppressHydrationWarning>
      <body suppressHydrationWarning style={{ margin: 0, padding: 0, fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
        {children}
        <CookieBanner />
        <script dangerouslySetInnerHTML={{ __html: "window.\$crisp=[];window.CRISP_WEBSITE_ID='768d7272-2c1a-4f47-8ca1-7c575519603c';window.CRISP_SETTINGS={position:'left'};(function(){d=document;s=d.createElement('script');s.src='https://client.crisp.chat/l.js';s.async=1;d.getElementsByTagName('head')[0].appendChild(s);})()" }} />
