...
// Settings mobile fliwoX. Card grandi cliccabili, ognuna apre full-screen.
  ...
  return (
    <div style={{ background: T.bg, minHeight: '100vh', paddingBottom: 100 }}>
      ...
      <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <CardSezione icona="🔗" titolo="Nodi tecnici" sub="Nodi costruttivi per sistema"        colore={T.numTeal}  onClick={() => setSezione('nodi')} />
        <CardSezione icona="📥" titolo="Importa da Excel" sub="Carica catalogo completo"        colore={T.numRed}   onClick={() => setSezione('importa')} />
      </div>
    </div>
  )
}
