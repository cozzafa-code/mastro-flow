      ...
      <div style={{ paddingBottom: 80, background: T.bg }}>
        ...
        <div style={{ margin: "8px 16px" }}>
          ...
          <div onClick={vrActive ? vrStop : vrStart}
            ...
            <span style={{ fontSize: 22 }}>{vrActive ? "Â " : "Â "}</span>
          ...
          {vrError && (
            ...
            <div style={{ marginTop: 6, padding: "6px 12px", borderRadius: 8, background: "#ffebee", border: "1px solid #ef9a9a", fontSize: 10, color: "#c62828", textAlign: "center" }}>
              ...
              <I d={ICO.alertTriangle} />Â  {vrError}
        ...
        {vanoStep === 0 && (() => {
          ...
          const sections = [
            ...
            { id:"accesso", icon:"Â  label:"Accesso / Difficolt
              ...
              body: <div style={{display:"flex",flexDirection:"column",gap:8}}>
                ...
                <div style={{display:"flex",gap:4}}>
                  ...
                  {[{id:"facile",l:"Facile",c:T.grn,e:""},{id:"media",l:"Media",c:T.orange,e:"Â "},{id:"difficile",l:"Difficile",c:T.red,e:""}].map(d=>(
            ...
            { id:"posizione", icon:"Â  label:"Stanza / Piano",
            ...
            { id:"colori", icon:" label:"Colori profili",
              ...
              body: <div style={{display:"flex",flexDirection:"column",gap:10}}>
                ...
                {!v.sistema && <div style={{padding:"14px",textAlign:"center",color:T.sub,fontSize:12,background:T.bg,borderRadius:10,border:"1px dashed "+T.bdr}}><I d={ICO.alertTriangle} />Â  Scegli prima il sistema profili</div>}
            ...
            { id:"controtelaio", icon:" label:"Controtelaio",
              ...
              body: <div style={{display:"flex",flexDirection:"column",gap:8}}>
                ...
                {v.controtelaio?.tipo==="singolo" && <>
                  ...
                  <div><div style={{fontSize:9,fontWeight:700,color:T.sub,marginBottom:2}}>PROFONDITv>
          ...
          return (
                  ...
                  <div key={sec.id} ref={el=>sectionRefs.current[sec.id]=el}
                    ...
                    <div onClick={()=>setVanoInfoOpen(isOpen?null:sec.id)}
                      ...
                      <div style={{display:"flex",alignItems:"center",gap:6}}>
                        ...
                        <span style={{fontSize:9,color:T.sub,display:"inline-block",transform:isOpen?"rotate(180deg)":"none",transition:"transform 0.15s"}}>an>
            ...
            <div style={{marginTop:8,borderRadius:10,border:`1px solid ${T.acc}30`,overflow:"hidden"}}>
              ...
              <div onClick={()=>setVanoInfoOpen(vanoInfoOpen==="strutture"?null:"strutture")}
                ...
                <span style={{fontSize:14}}><I d={ICO.building} />Â </span>
                ...
                <span style={{marginLeft:"auto",fontSize:9,color:T.sub,transform:vanoInfoOpen==="strutture"?"rotate(180deg)":"none",transition:"transform 0.15s"}}>an>
              ...
              {vanoInfoOpen==="strutture" && (
                ...
                <div style={{padding:12,background:T.bg,borderTop:"1px solid "+T.bdr}}>
                  ...
                  <div style={{textAlign:"center",padding:"20px 10px"}}>
                    ...
                    <div style={{fontSize:36,marginBottom:8}}><I d={ICO.building} />Â </div>
        ...
        <div style={{ padding: "8px 16px" }}>
                ...
                return (
                  ...
                  <div style={{ marginBottom:16 }}>
                    ...
                    <div style={{ padding:"10px 14px", borderRadius:10, background:"#E8A02010", border:"1px solid #E8A02030", marginBottom:12 }}>
                      ...
                      <div style={{ fontSize:11, fontWeight:700, color:"#E8A020" }}><I d={ICO.sparkles} />Â  Misure {isPergola ? "Pergola" : isBracci ? "Tenda a bracci" : isVela ? "Vela ombreggiante" : "Tenda/Schermatura"}</div>
                    ...
                    {(isPergola || isBracci) && (<>
                      ...
                      <div style={{ fontSize:11, fontWeight:800, color:"#E8A020", textTransform:"uppercase", letterSpacing:"0.08em", marginBottom:6, marginTop:12 }}>Â  {isPergola ? "Profondit : "Sporgenza (Aggetto)"}</div>
          ...
          {vanoStep === 1 && (
            ...
            <>
              ...
              {bInput("Davanzale PROFONDIT "davProf")}
              ...
              {v.cassonetto && (
                ...
                <div style={{ marginTop: 8 }}>
                  ...
                  {bInput("Cassonetto PROFONDIT "casP")}

                  {bInput("Cielino LARGHEZZA", "casLCiel")}

                  {bInput("Cielino PROFONDIT "casPCiel")}
              ...
              {["tapparella", "persiana", "zanzariera", "cassonetto"].map(acc => {
                ...
                const accIcons = { tapparella: "", persiana: "Â  zanzariera: "" };
              ...
              {detailOpen.vociLibere && (
                ...
                <div style={{ marginBottom: 12, padding: "0 4px" }}>
                  ...
                  {(v.vociLibere || []).map((voce, vi) => (
                    ...
                    <div key={voce.id || vi} style={{ padding: 10, borderRadius: 10, border: `1px solid ${T.bdr}`, background: T.card, marginBottom: 8 }}>
                      ...
                      <div style={{ display: "flex", gap: 4, marginBottom: 8 }}>
                        ...
                        {[{id:"generico",label:"Generico",color:"#E8A020"},{id:"vetro",label:" Vetro",color:"#3B7FE0"},{id:"coprifilo",label:"Â  Coprifilo",color:"#8B5CF6"}].map(t => (
                      ...
                      <div style={{ display: "flex", gap: 6 }}>
                        ...
                        <div style={{ width: 80 }}>
                          ...
                          <label style={{ fontSize: 9, color: T.sub, fontWeight: 700 }}>Unitbel>
                        ...
                        <div style={{ width: 60 }}>
                          ...
                          <label style={{ fontSize: 9, color: T.sub, fontWeight: 700 }}>Qtbel>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    ...
                    }} style={{ flex: 1, padding: 12, borderRadius: 10, border: `1px dashed #8B5CF6`, textAlign: "center", cursor: "pointer", color: "#8B5CF6", fontSize: 12, fontWeight: 600 }}>Â  Coprifilo</div>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                        ...
                        {libreriaDB.map(item => (
                          ...
                          <div key={item.id} onClick={() => {
                            ...
                            <div style={{ fontSize: 12, fontWeight: 700, color: T.grn, fontFamily: FM, flexShrink: 0 }}>tem.prezzo}/{item.unita || "pz"}</div>
                ...
                {(() => {
                  ...
                  return totOre > 0 ? (
                    ...
                    <div style={{ marginTop: 6, fontSize: 10, color: T.sub, display: "flex", justifyContent: "space-between" }}>
                      ...
                      <span>{totOre}h  ostoOra}/ora</span>
                ...
                {(() => {
                  ...
                  return <>
                    ...
                    {v.accessoriCatalogo && v.accessoriCatalogo.length > 0 && (
                      ...
                      <Sec title="ACCESSORI CATALOGO" color="#8B5CF6" icon="Â  rows={v.accessoriCatalogo.map(a => [`${a.nome}`, `${a.quantita}  ((a.prezzoUnitario||0)*(a.quantita||1)).toFixed(0)}`])} />
                    ...
                    {v.vociLibere && v.vociLibere.length > 0 && (
                      ...
                      <Sec title="VOCI LIBERE" color="#E8A020" icon=" rows={v.vociLibere.map(vl => {
                        ...
                        const label = vl.tipo === "vetro" ? ` ${vl.descrizione || "Vetro"}` : vl.tipo === "coprifilo" ? `Â  ${vl.descrizione || "Coprifilo"}` : ` ${vl.descrizione || "Voce"}`;
                    ...
                    {(v.difficoltaSalita || v.mezzoSalita) && (
                      ...
                      <Sec title="ACCESSO" color={v.difficoltaSalita === "facile" ? T.grn : v.difficoltaSalita === "difficile" ? "#DC4444" : "#E8A020"} icon="Â  rows={[
