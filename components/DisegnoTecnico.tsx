...
export default function DisegnoTecnico({ vanoId, vanoNome, vanoDisegno, realW: propRealW, realH: propRealH, onUpdate, onUpdateField, onClose, T }) {
  ...
  const realH = propRealH || 1000;
                              ...
                              if (drawMode === "line" || drawMode === "apertura") {
                                ...
                                if (!pending) {
                                  ...
                                  // Telaio libero / altri: snap normale, ma scarta snap troppo distanti dal dito
                                    ...
                                    if (adxC > 0 && adyC / Math.max(adxC, 1) > 2) px = pending.x1;        // dominante verticale → forza X
                                    else if (adyC > 0 && adxC / Math.max(adyC, 1) > 2) py = pending.y1;   // dominante orizzontale → forza Y
                            ...
                            const cursorMode = drawMode === "line" || drawMode === "apertura" || drawMode === "righello" || drawMode === "place-mont-free" || drawMode === "place-trav-free" || drawMode === "place-zocc-free" ? "crosshair" : drawMode ? "pointer" : "default";
                              ...
                              <div style={{
                                ...
                                <svg width="100%" height="100%"
                                  ...
                                  onMouseMoveDISABLED={(e2: any) => {
                                    ...
                                    if (adx > 0 && ady / Math.max(adx, 1) > 2) gx = p.x1;
                                    else if (ady > 0 && adx / Math.max(ady, 1) > 2) gy = p.y1;
                                  ...
                                  onTouchMove={(e2) => {
                                    ...
                                    if (adxT > 0 && adyT / Math.max(adxT, 1) > 2) gx = pp.x1;
                                    else if (adyT > 0 && adxT / Math.max(adyT, 1) > 2) gy = pp.y1;
