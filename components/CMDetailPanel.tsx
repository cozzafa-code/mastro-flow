                            ...
                            {acc.tapparella?.attivo && (
                              <div style={{ marginTop: 6, padding: 10, background: T.card, borderRadius: 8, border: `1px solid ${T.grn}15` }}>
                                ...
                                <div style={{ display: "flex", gap: 6, marginBottom: 6 }}>
                                  ...
                                  <div style={{ flex: 1 }}><div style={{ fontSize: 9, color: T.sub2 }}>Colore</div><select value={acc.tapparella.colore || ""} onChange={e => pwUpdVano(v.id, "accessori", { ...acc, tapparella: { ...acc.tapparella, colore: e.target.value } })} style={{ width: "100%", padding: "8px", fontSize: 11, border: `1px solid ${T.bdr}`, borderRadius: 6, background: T.card }}><option value="">— Colore —</option>{coloriDB.map(c => <option key={c.id} value={c.code}>{c.code} — {c.nome}</option>)}</select></div></div>
                                </div>
                            ...
                            {acc.persiana?.attivo && (
                              <div style={{ marginTop: 6, padding: 10, background: T.card, borderRadius: 8, border: `1px solid ${T.grn}15` }}>
                                ...
                                <div style={{ display: "flex", gap: 6 }}>
                                  ...
                                  <div style={{ flex: 1 }}><div style={{ fontSize: 9, color: T.sub2 }}>Colore</div><select value={acc.persiana.colore || ""} onChange={e => pwUpdVano(v.id, "accessori", { ...acc, persiana: { ...acc.persiana, colore: e.target.value } })} style={{ width: "100%", padding: "8px", fontSize: 11, border: `1px solid ${T.bdr}`, borderRadius: 6, background: T.card }}><option value="">— Colore —</option>{coloriDB.map(c => <option key={c.id} value={c.code}>{c.code} — {c.nome}</option>)}</select></div></div>
                                </div>
                          ...
                          <div style={{ marginBottom: 10 }}>
                            ...
                            {acc.zanzariera?.attivo && (
                              <div style={{ marginTop: 6, padding: 10, background: T.card, borderRadius: 8, border: `1px solid ${T.grn}15` }}>
                                ...
                                <div style={{ flex: 1 }}><div style={{ fontSize: 9, color: T.sub2 }}>Colore</div><select value={acc.zanzariera.colore || ""} onChange={e => pwUpdVano(v.id, "accessori", { ...acc, zanzariera: { ...acc.zanzariera, colore: e.target.value } })} style={{ width: "100%", padding: "8px", fontSize: 11, border: `1px solid ${T.bdr}`, borderRadius: 6, background: T.card }}><option value="">— Colore —</option>{coloriDB.map(c => <option key={c.id} value={c.code}>{c.code} — {c.nome}</option>)}</select></div></div>
