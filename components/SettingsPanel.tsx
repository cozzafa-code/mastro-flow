...
export default function SettingsPanel() {
  ...
  const SETTORI_FULL = [
    ...SETTORI,
    ...(!SETTORI.find((s: any) => s.id === "strutture") ? [{ id: "strutture", label: "Strutture", icon: "", desc: "Pergole, verande, pensiline, box, cancelli, ferro, tendaggi" }] : []),
  ];
  ...
  const sidebarGroups = [
    ...
    },
    {
      ...
      items: [
        { id: "sistemi",       l: "Sistemi profilo",   show: true },
        { id: "profili_arch",  l: "Archivio profili",  show: true },
        { id: "vetri",         l: "Vetri & pacchetti", show: true },
        { id: "colori",        l: "Colori & RAL",      show: true },
        { id: "coprifili",     l: "Coprifili",         show: true },
        { id: "lamiere",       l: "Lamiere",           show: true },
    ...
    },
    {
      ...
      items: [
        { id: "controtelaio",  l: "Controtelaio",      show: true },
        { id: "persiana",      l: "Persiane",          show: true },
        { id: "tapparella",    l: "Tapparelle",        show: true },
        { id: "cassonetto",    l: "Cassonetti",        show: true },
        { id: "zanzariera",    l: "Zanzariere",        show: true },
        { id: "porte_mat",     l: "Porte",             show: true },
        { id: "canc_mat",      l: "Cancelli",          show: true },
        { id: "strutture",     l: "Strutture",         show: true },
