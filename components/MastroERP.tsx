...
function MastroMisureInner({ user, azienda: aziendaInit, forceMobile, forceDesktop }: { user?: any, azienda?: any, forceMobile?: boolean, forceDesktop?: boolean }) {
  ...
  const S = {
    app: { fontFamily: FF, background: "#F5F4F0", color: T.text, width: "100%", maxWidth: "100vw", minHeight: "100vh", position: "relative", WebkitFontSmoothing: "antialiased", paddingBottom: 0, overflow: "hidden", boxSizing: "border-box" as any },
