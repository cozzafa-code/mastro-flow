...
// MOCK ALLINEATO AL MOCKUP HD: 8 operatori - 5 attivi - 1 problema - 1 pausa - 1 viaggio
const MOCK_OPERATORS: Operator[] = [
  ...
  { id: "op_ale",    name: "Alessandro Conti", avatar_url: getAvatarUrl("alessandro-conti"), status: "attivo", position_label: "Officina",     current_job: "Produzione Officina",     team_id: "sq_3", timer_label: "3h 02m", progress: 80, phone: "+39 333 5556677" },
  { id: "op_matteo", name: "Matteo Romano",    avatar_url: getAvatarUrl("matteo-romano"),    status: "attivo", position_label: "Officina",     current_job: "Produzione Officina",     team_id: "sq_3", timer_label: "3h 02m", progress: 80, phone: "+39 333 6667788" },
  { id: "op_stefano",name: "Stefano Greco",    avatar_url: getAvatarUrl("stefano-greco"),    status: "attivo", position_label: "Cantiere Bianchi", current_job: "Montaggio S-0007",    team_id: "sq_1", timer_label: "1h 45m", progress: 55, phone: "+39 333 7778899" },
  { id: "op_dario",  name: "Dario Russo",      avatar_url: getAvatarUrl("dario-russo"),      status: "attivo", position_label: "Showroom",     current_job: "Misure cliente Esposito",  team_id: "sq_2", timer_label: "0h 50m", progress: 35, phone: "+39 333 8889900" },
];
